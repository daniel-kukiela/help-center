...
<p>There exist MAC address ranges that will never be assigned to any physical network intercfaces by any manufactorers, called <i>locally administrated addresses</i>, and the patterns are:<p>
<ul>
